(() => {
  ...
  var require_topbar = __commonJS({
    "vendor/topbar.js"(exports, module) {
      (function() {
        var topbar2 = { version: "0.1.4" };
        topbar2.config = function(cfg2) {
          for (var prop in cfg2) {
            topbar2[prop] = cfg2[prop];
          }
        };
        topbar2.hide = function() {
          var style = topbar2.el.style;
          style.opacity = "0";
          setTimeout(function() {
            style.display = "none";
          }, topbar2.fadeOutDelay);
        };
        topbar2.show = function() {
          var style = topbar2.el.style;
          style.display = "block";
          setTimeout(function() {
            style.opacity = "1";
        ...
        var cfg = {
          ...
          barColors: {
            ...
            // blue
            ".50": "rgba(155, 89,  182, .7)",
            // purple
            ".75": "rgba(52,  73,  94, .7)",
            // dark blue
            "1.0": "rgba(22,  160, 133, .7)"
            // turquoise
          },
          barWidth: 0,
          barHeight: "3px",
        ...
        topbar2.config(cfg);
        var k, v, str = "", el = document.createElement("div");
        el.className = topbar2.className;
        for (k in topbar2.barColors) {
          str += (k == 0 ? "" : ",") + topbar2.barColors[k];
        }
        el.style.cssText = "position:fixed;top:0;left:0;width:100%;height:" + topbar2.barHeight + ";z-index:" + topbar2.zindex + ";background:" + str + ";box-shadow:0 0 " + topbar2.shadowBlur + " " + topbar2.shadowColor + ";transition:width " + topbar2.fadeOutDelay + "ms ease-out,opacity " + topbar2.fadeOutDelay + "ms ease-out;opacity:0;width:0;";
        document.body.appendChild(el);
        topbar2.el = el;
        var i = 0, oldi = 0;
        var progress = function() {
          var width = 100 * Math.cos(i++ / 3);
          if (width < 10)
            width = 10;
          if (width > 90)
            i = 0;
          ...
          if (oldi - width > 3)
            width = oldi - 3;
          oldi = width;
          topbar2.el.style.width = width + "%";
          if (width < 90) {
            requestAnimationFrame(progress);
          }
        };
        topbar2.progress = function() {
          if (topbar2.el.style.display != "block") {
            topbar2.show();
            progress();
          }
        };
        if (typeof window !== "undefined") {
          ...
          if (typeof addEventListener !== "undefined") {
            addEventListener("load", topbar2.hide, false);
...
`);
  ...
  window.addEventListener("phx:page-loading-start", (_info) => import_topbar.default.show(100));
